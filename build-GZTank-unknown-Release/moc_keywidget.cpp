...
#include "../GameClient/keywidget.h"
...
QT_MOC_LITERAL(1, 10, 11), // "shootSignal"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 9), // "EMPSignal"
QT_MOC_LITERAL(4, 33, 11) // "FlashSignal"

    },
    "KeyWidget\0shootSignal\0\0EMPSignal\0"
    "FlashSignal"
};
...
void KeyWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->shootSignal(); break;
        case 1: _t->EMPSignal(); break;
        case 2: _t->FlashSignal(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&KeyWidget::shootSignal)) {
                *result = 0;
            }
        }
        {
            typedef void (KeyWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&KeyWidget::EMPSignal)) {
                *result = 1;
            }
        }
        {
            typedef void (KeyWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&KeyWidget::FlashSignal)) {
                *result = 2;
            }
        }
    }
...
// SIGNAL 0
void KeyWidget::shootSignal()
{
    QMetaObject::activate(this, &staticMetaObject, 0, Q_NULLPTR);
}

// SIGNAL 1
void KeyWidget::EMPSignal()
{
    QMetaObject::activate(this, &staticMetaObject, 1, Q_NULLPTR);
}

// SIGNAL 2
void KeyWidget::FlashSignal()
{
